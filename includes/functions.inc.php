...
function mac_exist($host, $server, $mac){
	...
	include "config.inc.php";
        ...
        if ($total_rows_mac > 0){
                ...
                print "<center><table>\n";
                print "<tr><td><font color=ff0000><b>MAC address *$mac* existed in the database on server *$server* already!  If you want to add the MAC address to the other server(s), please go back and unselect server *$server*.</b></font></td></tr>\n";
                print "</table></center>\n";
                include "$footer";
                exit;
        }
